...
export default function ItemCard({itemSet, onQuickViewClick}: {itemSet: ItemSet, onQuickViewClick: (e: any, id: number)=> void}) {
    ...
    <div className="flex flex-col h-full min-h-[300px] border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-white">
      <div className="p-4 flex-grow">
        ...
        <div className="relative w-full h-48 mb-4">
          <Image
            src={itemSet.url} // Replace with your product image path
            alt="Product Image"
            layout="fill"
            objectFit="contain"
        ...
        {/* Price */}
        <p className="text-xl font-bold text-gray-900 mb-4">$29.99</p>

        {/* Free Delivery */}
        <p className="text-sm text-green-600 mb-2">FREE Delivery on orders over $25</p>
